...
export default function RegisterPage() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 p-4 max-w-md mx-auto">
        ...
        <button type="submit" className="bg-gray-800 text-white hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 cursor-pointer">Register</button>
        {mutation.isError && <p>Error logging in: {mutation.error.message}</p>}
        {mutation.isSuccess && <p>Register successful!</p>}
    </form>
  )
}